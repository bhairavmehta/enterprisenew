...
class program:
    ...
    def main(self):
        ...
        self.topic = "out_topic_ad_multi_sensors_notif_test"
        ...
        img_abnormal_0 = ImageTk.PhotoImage(Image.open("anomaly_0.png"))
        img_abnormal_1 = ImageTk.PhotoImage(Image.open("anomaly_1.png"))
        img_abnormal_2 = ImageTk.PhotoImage(Image.open("anomaly_2.png"))
        
        # start side thread on listening to notification
        def handle_callback(notif_id: str):
            if "abnormal_0" in notif_id:
                lbl.configure(text="Abnormal.", image=img_abnormal_0)
            elif "abnormal_1" in notif_id:
                lbl.configure(text="Abnormal.", image=img_abnormal_1)
            elif "abnormal_2" in notif_id:
                lbl.configure(text="Abnormal.", image=img_abnormal_2)
            else:
...
def main():
    ...
    topic = "out_topic_ad_multi_sensors_notif_test"
